...
protected:
	...
	MulticastDelegate<const MouseMoveEventArgs&> onMouseMove_;
	MulticastDelegate<const InputKey&> onKeyDown_;
	MulticastDelegate<const InputKey&> onKeyUp_;
	
	void KeyboardEvent(KeyboardInputEventArgs args);
	void MouseEvent(RawMouseEventArgs args);
};
